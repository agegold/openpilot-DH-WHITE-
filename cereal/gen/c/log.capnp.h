...
struct cereal_ControlsState {
	...
	uint32_t cruiseSetMode;
	capn_text alertTextMsg1;
	capn_text alertTextMsg2;
	float pCurvature;
	float curvMaxSpeed;
	float targetSpeed;
	float longWaitCmd;
...
static const size_t cereal_ControlsState_word_count = 25;

static const size_t cereal_ControlsState_pointer_count = 8;

static const size_t cereal_ControlsState_struct_bytes_count = 264;
...
static const size_t cereal_Plan_word_count = 11;

static const size_t cereal_Plan_pointer_count = 3;

static const size_t cereal_Plan_struct_bytes_count = 112;
