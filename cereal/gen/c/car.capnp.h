...
enum cereal_CarEvent_EventName {
	...
	cereal_CarEvent_EventName_manualSteeringRequired = 69,
	cereal_CarEvent_EventName_manualSteeringRequiredBlinkersOn = 70,
	cereal_CarEvent_EventName_turningIndicatorOn = 71,
	cereal_CarEvent_EventName_lkasButtonOff = 72,
	cereal_CarEvent_EventName_rightLCAbsm = 73,
	cereal_CarEvent_EventName_leftLCAbsm = 74,
	cereal_CarEvent_EventName_preventLCA = 75,
	cereal_CarEvent_EventName_invalidLkasSetting = 76,
	cereal_CarEvent_EventName_speedTooHigh = 77,
	cereal_CarEvent_EventName_laneChangeBlocked = 78,
	cereal_CarEvent_EventName_relayMalfunction = 79,
	cereal_CarEvent_EventName_steerTorqueOver = 80,
	cereal_CarEvent_EventName_ldwPermanent = 81
};
